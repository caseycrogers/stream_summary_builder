...
class StreamSummaryBuilder<T, S>
  ...
  ///
  /// Rebuild an existing stream summary builder with a null value for [stream]
  /// to stop the stream builder with it's current summary. It will still be
  /// built and rebuilt with the values seen so far, but it will not listen to
  /// any future events from the stream.
